...
use super::{cleanup_session, initialize_session, register_project, DaemonOps, RegisterResponse};
use crate::session::project_detect::ProjectInfo;

// ─────────────────────────────────────────────────────────────────────────────
// MockDaemonOps — test double (moved here from lifecycle.rs)
// ─────────────────────────────────────────────────────────────────────────────
...
fn no_project_detect(_cwd: &std::path::Path, _sm: &StateManager) -> Option<ProjectInfo> {
    None
}
