...
impl Migration for V01Migration {
    async fn up(&self, pool: &SqlitePool) -> Result<(), SchemaError> {
        ...
        use crate::watch_folders_schema::{CREATE_WATCH_FOLDERS_SQL, CREATE_WATCH_FOLDERS_INDEXES_SQL};
    ...
    fn description(&self) -> &'static str { "Create initial spec-compliant tables" }
}
