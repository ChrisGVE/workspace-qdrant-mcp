...
use wqm_proto::workspace_daemon::{QueryRelatedRequest, QueryRelatedResponse, TraversalNodeProto};
...
mod tests {
    use super::*;
    use wqm_proto::workspace_daemon::{QueryRelatedResponse, TraversalNodeProto};
