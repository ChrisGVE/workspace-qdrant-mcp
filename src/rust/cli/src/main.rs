...
The CLI provides commands for:
  ...
  • Library documentation indexing with file watching
  • Status monitoring with queue and performance metrics
...
QUICK START:
  ...
  3. Add a documentation library:
     $ wqm library watch python-docs ~/docs/python
...
EXAMPLES:
    ...
    wqm library watch docs ~/docs   Watch a folder for documentation
    wqm status --live               Real-time status monitoring
    wqm service logs -f             Follow daemon logs

ENVIRONMENT VARIABLES:
    WQM_DAEMON_ADDR    Daemon gRPC address (default: http://127.0.0.1:50051)

For more information, visit: https://github.com/ChrisGVE/workspace-qdrant-mcp";
