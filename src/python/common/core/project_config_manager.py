...
class DaemonProjectConfig(BaseModel):
    ...
    grpc_port: int | None = None  # Auto-allocated if None
    log_level: str = "info"
...
class ProjectConfigManager:
    ...
    def __init__(self, project_path: str):
        ...
        self.cached_config: DaemonProjectConfig | None = None
        self.config_checksum: str | None = None
    ...
    def get_config_paths(self, instance_id: str | None = None) -> dict[ConfigScope, Path]:
    ...
    def load_config(self, instance_id: str | None = None, force_reload: bool = False) -> DaemonProjectConfig:
        """
    ...
    def start_watching(self) -> None:
        ...
        for _scope, path in config_paths.items():
            if path.exists():
    ...
    @asynccontextmanager
    async def config_context(self, instance_id: str | None = None):
    ...
    def get_resource_limits(self, config: DaemonProjectConfig | None = None) -> ResourceLimits:
    ...
    def _load_config_file(self, path: Path, scope: ConfigScope) -> DaemonProjectConfig | None:
...
def load_project_config(project_path: str, instance_id: str | None = None) -> DaemonProjectConfig:
