...
try:
    ...
    from .collection_naming import CollectionType as NamingCollectionType
...
def can_llm_create_collection(name: str, config: ConfigManager | None = None) -> bool:
    """
...
def can_llm_delete_collection(name: str, config: ConfigManager | None = None) -> bool:
    """
...
def validate_llm_collection_access(operation: str, name: str, config: ConfigManager | None = None) -> None:
    """
...
def get_forbidden_collection_patterns(config: ConfigManager | None = None) -> list[str]:
    """
