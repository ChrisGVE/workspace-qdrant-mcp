...
from .lsp_metadata_extractor import LspMetadataExtractor
...
class RouterConfiguration:
    ...
    @classmethod
    def from_yaml(cls, config_path: str | Path) -> "RouterConfiguration":
...
class FileClassifier:
    ...
    def __init__(self, config: RouterConfiguration, pattern_manager: PatternManager | None = None):
        self.config = config
...
class SmartIngestionRouter:
    ...
    def __init__(
        ...
        lsp_extractor: LspMetadataExtractor | None = None,
    ...
    ) -> tuple[ProcessingStrategy, ClassificationResult | None]:
        """
