...
class LanguageAwareFilter:
    ...
    def __init__(
        ...
        self.config: FilterConfiguration | None = None
    ...
    async def load_configuration(self, config_file: str | None = None) -> None:
        """
    ...
    def should_process_file(self, file_path: str | Path) -> tuple[bool, str]:
        """
    ...
    def _matches_ignored_regex(self, file_path: str) -> str | None:
