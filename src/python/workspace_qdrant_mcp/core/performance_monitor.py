...
Task 265: Performance monitoring coordinator for the workspace_qdrant_mcp system.
"""
...
from .performance_metrics import (
    MetricType, PerformanceMetricsCollector, PerformanceMetric, OperationTrace
)
...
class PerformanceMonitor:
    ...
    def profile_operation(self, operation_type: str, context: Optional[Dict[str, Any]] = None):
    ...
    async def _check_metric_alerts(self, metric: PerformanceMetric):
        ...
        if "critical" in thresholds and metric.value > thresholds["critical"]:
            ...
            alert = PerformanceAlert(
                ...
                recommendations=[f"Monitor {metric.metric_type.value} trends"]
            )
            ...
            if summary.trend == "degrading":
                ...
                if (alert_key not in self.last_alert_times or
                    ...
                    alert = PerformanceAlert(
                        ...
                        recommendations=[f"Investigate {metric_type.value} degradation"]
                    )
