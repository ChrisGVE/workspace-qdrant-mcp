...
def cli_entry_point():
    ...
    This function is the proper entry point for pyproject.toml scripts,
    as it calls the Typer app without requiring the ctx argument that
    the main() callback receives.
    """
    app()
