...
export class ProjectDetector {
     ...
     */
    async getProjectInfo(projectPath, waitForRegistration = false) {
     ...
     */
    async getCurrentProject(cwd = process.cwd(), waitForRegistration = false) {
     ...
     */
    async getCurrentProjectId(cwd = process.cwd(), waitForRegistration = false) {
     ...
     */
    async fetchWithRetry(projectPath) {
