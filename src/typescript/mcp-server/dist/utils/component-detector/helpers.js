 ...
 */
export function pathToComponentId(path) {
    return path
 ...
 */
export function fileMatchesComponent(relativePath, component) {
 ...
 */
export function componentMatchesFilter(componentId, filter) {
 ...
 */
export function assignComponent(relativePath, components) {
    let bestMatch;
    let bestLength = -1;
