...
from .types import (
    MemoryRule, MemoryRuleConflict, AuthorityLevel, MemoryCategory,
    MemoryContext, ConversationalUpdate, ClaudeCodeSession, MemoryInjectionResult
)
...
class MemoryManager:
    ...
    def __init__(self, 
                 ...
                 qdrant_client: Optional[QdrantWorkspaceClient] = None,
    ...
    async def get_rule(self, rule_id: str) -> Optional[MemoryRule]:
        """
    ...
    async def list_rules(self,
                        ...
                        authority_filter: Optional[AuthorityLevel] = None,
                        source_filter: Optional[str] = None) -> List[MemoryRule]:
        """
    ...
    async def process_conversational_text(self, 
                                        text: str,
                                        session_context: Optional[MemoryContext] = None) -> List[MemoryRule]:
        """
