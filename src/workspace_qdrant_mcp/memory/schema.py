...
from .types import MemoryRule, AuthorityLevel, MemoryCategory
...
class MemoryCollectionSchema:
    ...
    async def ensure_collection_exists(self) -> bool:
        ...
        try:
            ...
            if self.COLLECTION_NAME not in collection_names:
                ...
                logger.info(f"Successfully created memory collection")
                return True
            else:
    ...
    async def search_rules(self, 
                          ...
                          tag_filter: Optional[List[str]] = None) -> List[Tuple[MemoryRule, float]]:
        """
    ...
    def _point_to_rule(self, point) -> Optional[MemoryRule]:
        """
