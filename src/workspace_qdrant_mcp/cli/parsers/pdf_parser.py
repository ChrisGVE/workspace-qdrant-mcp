...
class PDFParser(DocumentParser):
        ...
        **options
        ...
        try:
            with open(file_path, 'rb') as pdf_file:
                ...
                parsing_info["pages_processed"] = min(num_pages, max_pages) if max_pages else num_pages
                ...
                additional_metadata = {
                    ...
                    "avg_words_per_page": len(content.split()) / pages_processed if pages_processed > 0 and content else 0,
                }
    ...
    async def _extract_pdf_metadata(self, pdf_reader) -> Dict[str, Any]:
        """
    ...
    def _analyze_pdf_content(self, content: str, pages_processed: int) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            "avg_words_per_page": len(words) / pages_processed if pages_processed > 0 else 0,
            "avg_chars_per_page": len(content) / pages_processed if pages_processed > 0 else 0,
        }
    
    def get_parsing_options(self) -> Dict[str, Dict]:
