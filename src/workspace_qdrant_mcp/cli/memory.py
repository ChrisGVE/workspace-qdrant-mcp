...
def list(category: Optional[str], authority: Optional[str], scope: Optional[str], output_json: bool):
...
def add(rule: Optional[str], category: Optional[str], authority: str, scope: Optional[str], interactive: bool):
...
async def _trim_memory(max_tokens: int, dry_run: bool):
    ...
    try:
        ...
        console.print(f"[bold blue]Memory Optimization[/bold blue]")
