...
def search_project(
    ...
    collections: Optional[List[str]] = typer.Option(None, "--collection", "-c", help="Specific collections to search"),
...
def search_memory(
    ...
    limit: int = typer.Option(10, "--limit", "-n", help="Maximum number of results"),
    category: Optional[str] = typer.Option(None, "--category", help="Filter by memory category"),
    authority: Optional[str] = typer.Option(None, "--authority", help="Filter by authority level"),
...
def research_query(
    ...
    collections: Optional[List[str]] = typer.Option(None, "--collection", "-c", help="Collections to include in research"),
    output_file: Optional[str] = typer.Option(None, "--output", "-o", help="Save research report to file"),
...
async def _search_memory(
    ...
    """Search memory rules and knowledge graph."""
    try:
        from ...core.memory import create_memory_manager, MemoryCategory, AuthorityLevel
