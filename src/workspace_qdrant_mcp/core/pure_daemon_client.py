...
class PureDaemonWorkspaceClient:
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            logger.error("Failed to initialize pure daemon client", error=str(e), exc_info=True)
    ...
    async def get_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("Unexpected error while getting status", error=str(e), exc_info=True)
            return {
                "connected": False,
    ...
    async def list_collections(self) -> List[str]:
        ...
        try:
            ...
            logger.error("Unexpected error while listing collections", error=str(e), exc_info=True)
            return []
    ...
    async def add_document(
        ...
        try:
            ...
            logger.error("Unexpected error while adding document", error=str(e), exc_info=True)
            return {
                "success": False,
                "error": f"Unexpected error: {e}"
            }
    ...
    async def get_document(
        ...
        try:
            ...
            logger.error("Unexpected error while getting document", error=str(e), exc_info=True)
            return {
                "error": f"Unexpected error: {e}"
            }
    ...
    async def search(
        ...
        try:
            ...
            logger.error("Unexpected error while searching", error=str(e), exc_info=True)
            return {
                "error": f"Unexpected error: {e}",
                "total_results": 0,
                "results": []
    ...
    async def search_by_metadata(
        ...
        try:
            ...
            logger.error("Unexpected error while searching by metadata", error=str(e), exc_info=True)
            return {
                "error": f"Unexpected error: {e}",
                "results": []
            }
    ...
    async def get_resource_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("Unexpected error while getting resource stats", error=str(e), exc_info=True)
    ...
    async def _initialize_workspace_collections(self) -> None:
        ...
        try:
            ...
            if result.get("success", False):
                ...
                logger.warning("Workspace initialization via daemon failed", error=result.get("error"))
                
        except Exception as e:
            logger.error("Failed to initialize workspace collections via daemon", error=str(e))
            raise
        ...
        if self.mcp_active != active:
            ...
            try:
                await self.daemon_client.call_method(
                    "set_mcp_active",
                    {"active": active, "timestamp": datetime.now(timezone.utc).isoformat()}
                )
