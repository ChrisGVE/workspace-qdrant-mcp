...
class DaemonClient:
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            options = [
                ...
                ('grpc.max_receive_message_length', grpc_config.max_message_size_mb * 1024 * 1024),
                ('grpc.max_send_message_length', grpc_config.max_message_size_mb * 1024 * 1024),
            ]
    ...
    async def list_collections(self, include_stats: bool = False) -> ListCollectionsResponse:
