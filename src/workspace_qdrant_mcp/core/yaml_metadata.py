...
from ..cli.parsers import DocumentParser, ParsedDocument, PDFParser, MarkdownParser, TextParser
...
class MetadataExtractor:
    ...
    def _extract_authors_from_content(self, content: str) -> Optional[str]:
    ...
    def _extract_isbn_from_content(self, content: str) -> Optional[str]:
    ...
    def _extract_journal_from_content(self, content: str) -> Optional[str]:
    ...
    def _extract_publication_date_from_content(self, content: str) -> Optional[str]:
