...
impl DocumentProcessor {
    ...
    pub async fn process_file(&self, file_path: &Path, collection: &str) -> Result<DocumentResult, ProcessingError> {
...
mod tests {
    ...
    async fn test_document_processor() {
        ...
        assert!(processor.process_file(Path::new("/tmp/test.txt"), "test").await.is_err());
    }
}