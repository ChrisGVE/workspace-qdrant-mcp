"""
Comprehensive test coverage for src/python/common/core/metadata_schema.py
...
class TestMetadataSchema:
    """Comprehensive test coverage for MetadataSchema module."""
...
class TestMetadataSchemaIntegration:
    """Integration tests for MetadataSchema module."""
...
class TestMetadataSchemaEdgeCases:
    """Edge case and stress tests for MetadataSchema module."""
