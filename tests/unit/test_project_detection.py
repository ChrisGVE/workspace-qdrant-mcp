...
class TestProjectDetector:
    ...
    def test_get_subprojects_with_submodules_no_filter(self, temp_git_repo_with_submodules):
    ...
    def test_get_project_info_comprehensive(self, temp_git_repo):
        ...
        expected_fields = [
            "main_project", "subprojects", "git_root", "remote_url",
            "main_url_info", "github_user", "path", "is_git_repo",
            "belongs_to_user", "detailed_submodules", "submodule_count",
    ...
    def test_detailed_submodules_analysis(self, temp_git_repo_with_submodules):
        ...
        with patch('workspace_qdrant_mcp.utils.project_detection.git.Repo') as mock_repo_class:
            ...
            with patch('os.path.exists', return_value=True), \
                ...
                detailed = detector.get_detailed_submodules(temp_git_repo_with_submodules)
                
                assert len(detailed) == 1
                submodule_info = detailed[0]
                
                expected_fields = [
                    "name", "path", "url", "project_name", "is_initialized",
                    "user_owned", "commit_sha", "url_info", "local_path"
                ]
    ...
    @pytest.mark.parametrize("url,expected_components", [
        (
