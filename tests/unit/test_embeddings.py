...
class TestEmbeddingService:
    ...
    async def test_initialize_with_sparse_vectors(self, service):
        ...
        with patch('workspace_qdrant_mcp.core.embeddings.TextEmbedding') as mock_text_embedding, \
             patch('workspace_qdrant_mcp.core.embeddings.BM25SparseEncoder') as mock_bm25_class:
    ...
    @pytest.mark.asyncio
    async def test_generate_embeddings_sparse_requested_but_not_available(self, service):
