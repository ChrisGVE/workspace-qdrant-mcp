...
class TestCanonicalCollections:
    """Tests for CANONICAL_COLLECTIONS constant (ADR-001)."""

    def test_collections_defined(self):
        """Test that all canonical collections are defined."""
    ...
    def test_collection_names_correct(self):
        """Test that collection names follow naming convention (no underscore prefix per ADR-001)."""
