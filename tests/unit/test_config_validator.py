...
class TestConfigValidator:
    ...
    def test_validate_qdrant_connection_success(self, mock_config):
        ...
        with patch('workspace_qdrant_mcp.utils.config_validator.QdrantClient') as mock_qdrant:
    ...
    def test_validate_embedding_model_success(self, mock_config):
        ...
        with patch('workspace_qdrant_mcp.utils.config_validator.EmbeddingService') as mock_embedding_service:
    ...
    def test_validate_project_detection_git_repo(self, mock_config, temp_git_repo):
        ...
        with patch('workspace_qdrant_mcp.utils.config_validator.ProjectDetector') as mock_detector_class:
    ...
    def test_validate_all_with_warnings(self, mock_config):
        ...
        with patch.object(validator, 'validate_qdrant_connection', return_value=(True, "Qdrant OK")), \
            ...
            assert len(results["issues"]) == 0
            assert len(results["warnings"]) > 0
            assert any("GitHub user not configured" in warning for warning in results["warnings"])
    ...
    def test_validate_all_comprehensive_results(self, mock_config):
        ...
        with patch.object(validator, 'validate_qdrant_connection', return_value=(True, "Qdrant OK")), \
            ...
            expected_keys = [
                "issues", "warnings", "qdrant_connection", 
                "embedding_model", "project_detection", "config_validation"
            ]
            ...
            for validation_key in ["qdrant_connection", "embedding_model", "project_detection"]:
