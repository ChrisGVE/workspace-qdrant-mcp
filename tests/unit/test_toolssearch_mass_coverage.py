"""
Comprehensive test coverage for src/python/workspace_qdrant_mcp/tools/search.py
...
class TestToolsSearch:
    """Comprehensive test coverage for ToolsSearch module."""
...
class TestToolsSearchIntegration:
    """Integration tests for ToolsSearch module."""
...
class TestToolsSearchEdgeCases:
    """Edge case and stress tests for ToolsSearch module."""
