...
class TestCanonicalCollectionNames:
    """Tests for canonical collection naming convention (ADR-001)."""

    def test_projects_collection_name(self):
        """Test that project watches route to projects collection (no underscore per ADR-001)."""
        # ADR-001: Canonical collections do NOT use underscore prefix
        expected_collection = "projects"
        assert not expected_collection.startswith("_")

    def test_libraries_collection_name(self):
        """Test that library watches route to libraries collection (no underscore per ADR-001)."""
        # ADR-001: Canonical collections do NOT use underscore prefix
