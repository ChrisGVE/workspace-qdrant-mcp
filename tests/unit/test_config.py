...
class TestConfig:
    ...
    @pytest.mark.parametrize("chunk_size,chunk_overlap,expected_issues", [
        (1000, 200, 0),  # Valid
    ...
    def test_validate_config_chunk_settings(self, chunk_size, chunk_overlap, expected_issues):
