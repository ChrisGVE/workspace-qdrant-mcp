...
# ============================================================================
# Canonical Collections Tests (ADR-001)
# ============================================================================

class TestCanonicalCollections:
    """Tests for canonical collection constants and behavior (ADR-001)."""

    def test_canonical_collections_defined(self):
    ...
    def test_canonical_collections_naming_no_underscore_prefix(self):
        """Test that collection names have NO underscore prefix per ADR-001."""
        from workspace_qdrant_mcp.server import CANONICAL_COLLECTIONS

        # ADR-001: Canonical collections do NOT use underscore prefix
