...
class TarpaulinParser(BaseParser):
    ...
    def parse(
        self, coverage_json_path: Path, source_root: Path | None = None
    ) -> CoverageMetrics:
        """
...
class TarpaulinLcovParser(BaseParser):
    ...
    def parse(
        self, lcov_path: Path, source_root: Path | None = None
    ) -> CoverageMetrics:
        """
...
def parse_tarpaulin_json(
    coverage_json_path: Path, source_root: Path | None = None
) -> CoverageMetrics:
    """
...
def parse_tarpaulin_lcov(
    lcov_path: Path, source_root: Path | None = None
) -> CoverageMetrics:
    """
