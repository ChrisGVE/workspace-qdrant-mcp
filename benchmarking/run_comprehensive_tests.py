...
class ComprehensiveTestRunner:
    ...
    def _extract_metrics_from_output(self, output: str, category: str) -> Dict[str, Any]:
    ...
    def _generate_markdown_report(self, summary: Dict[str, Any]) -> str:
        ...
        report.append(f"**Duration:** {summary['test_run_info']['total_duration_seconds']:.1f} seconds")
        report.append(f"**Success Rate:** {summary['test_run_info']['success_rate']*100:.1f}%")
        report.append("")
...
def main():
    ...
    parser.add_argument(
        "--categories",
        nargs="+",
        choices=["data_ingestion", "search_functionality", "mcp_integration", "performance", "recall_precision"],
